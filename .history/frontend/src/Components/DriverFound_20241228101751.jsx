               ...
               <div className='flex flex-row justify-between mt-4'>
                ...
                <img src={user} alt="image" className='h-[15vh] w-[22vh] absolute left-5'/>
                  ...
                  <div className='flex flex-col text-right'>
                    <span className='text-lg font-medium'>{user.captain.fullName.firstName} {user.captain.fullName.firstName}</span>
              ...
              <div className='flex flex-col w-full mt-4 gap-3'>
                  ...
                  <div className='flex flex-row gap-2  w-full'>
                      ...
                      <div className='flex flex-col'>
                          ...
                          <span className='text-gray-700'>Cash, {user.captain.vehicle.typeVehicle}</span>
                      </div>
                  </div>
              </div>
