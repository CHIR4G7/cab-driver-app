    ...
    if(!ride){
      ...
      return (
          <div className={`${driverFound ? '' : 'hidden'} w-full bg-white absolute bottom-0 flex flex-col rounded-xl p-2 pb-4 pl-2`}>
              ...
              <button className={`${rideStarted ? '' : 'hidden'} mt-3 border-2 border-black text-white bg-black w-[100%] p-2 rounded-lg flex flex-row items-center justify-center gap-2`}
              onClick={()=>{
                navigate('/user-home')
              }} >Pay</button>
          </div>
