...
const RideAlert = () => {
    ...
    return (
        <div className='absolute bg-gray-100 w-full flex flex-col bottom-0 pt-4 pb-6 rounded-t-2xl'>
            <span className='pl-3 font-medium text-xl'>New Ride Nearby!</span>
            ...
            <button className='mt-3 border-2 border-black text-white bg-black w-[20%] p-1 rounded-lg flex flex-row items-center justify-center gap-2' >Accept</button>
            <span className='mt-4 font-medium text-gray-600'>Ignore</span>
