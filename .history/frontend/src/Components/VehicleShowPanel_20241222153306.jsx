...
const VehicleShowPanel = ({booking,selecting,setBooking,setSelecting,setConfirmRide}) => {
  return (
     <div className={`fixed bottom-0 ${booking ? '' : 'hidden'} bg-white w-full rounded-2xl pt-4 pb-4`}>
           ...
           <div className='border-2 active:border-black bg-gray-100 flex flex-row gap-2 rounded-xl m-2' onClick={()=>{
           ...
           <div className='border-2 active:border-black bg-slate-100 flex flex-row gap-2 rounded-xl m-2' onClick={()=>{
            setConfirmRide((prev)=>!prev)
           }}>
