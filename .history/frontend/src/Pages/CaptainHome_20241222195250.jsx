...
const CaptainHome = () => {
  ...
  return (
    <div>
            ...
            <div className='absolute bg-white w-full flex flex-col bottom-0 pt-4'>
              <div className='flex flex-row justify-between px-2'>
                <div className='flex flex-col'>
                  <span className='font-medium text-xl'>Your Details : </span>
                  <div className='flex flex-row gap-1'>
                    <img src={user} alt="" className='h-5 w-10'/>
                  <span>{captain.fullName.firstName} {captain.fullName.lastName}</span>
                  </div>
              
                </div>
             
                <div>
                <span className='font-medium text-xl'>Today's Earnings</span>
                </div>
