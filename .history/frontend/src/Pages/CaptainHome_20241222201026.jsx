  ...
  return (
    <div>
      ...
      <div className='absolute bg-white w-full flex flex-col bottom-0 pt-4 pb-4'>
        ...
        <div className='h-20 m-3 bg-yellow-300 text-black rounded-lg flex items-center justify-center'>
          <div className='border-2 border-black flex flex-row gap-4'>
            <div className='flex flex-col items-center justify-center'>
            <span className='text-center'><IoSpeedometerOutline size={20}/></span>
            <span className='text-[1.5vh]'>HOURS ONLINE</span>
            </div>
