...
const CaptainRide = () => {
  ...
  return (
    <div>
      ...
      {/* Get Otp Component */}
      {confirmRideCaptain && rideDetails.status==='pending' && <BeginRideOtp ride={rideDetails}/>}

      {/* Ride has Started now all the info is in this component */}
      {(rideDetails.status==='ongoing' || rideDetails.status==='accepted') && <RideStart ride={rideDetails}/>}
