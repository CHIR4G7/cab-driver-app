...
const MapHome = () => {
  ...
  return (
    <div>
      ...
      <div className='absolute bg-white top-0 w-full flex flex-col gap-3 p-2 ml-2'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-2'>
          ...
          <div>
          <div className='h-4 w-4 bg-black flex flex-col justify-center items-center absolute top-[10vh] left-[0.8vh]'>
              <div className='h-1 w-1 bg-white '></div>
            </div>
            <input type="text"
