...
const MapHome = () => {
  ...
  return (
    <div>
      ...
      {!selecting && <div className='absolute bg-white bottom-0 w-full flex flex-col gap-3 p-2 rounded-3xl pl-6 pb-3' onClick={()=>setSelecting(!selecting)}>
      ...
      {selecting && <div className='h-screen w-screen bg-white z-10 absolute top-0'>
