...
const MapHome = () => {
  ...
  return (
    <div>
      ...
      <div className={`absolute bg-white w-full flex flex-col gap-3 p-2  pl-6 pb-3 ${selecting ? 'top-0 mt-4 rounded-xl' : 'bottom-0 rounded-3xl'}`} onClick={()=>setSelecting(!selecting)}>
