...
const MapHome = () => {
  ...
  return (
    <div>
      ...
      <div className={`absolute bg-white w-full flex flex-col gap-3 p-2  pl-6 pb-3 ${selecting ? 'top-0 mt-4 rounded-xl h-screen' : 'bottom-0 rounded-3xl'}`} onClick={()=>setSelecting(true)}>
        <div className='flex flex-row gap-2'>
        {selecting && <FaArrowLeft className='mt-2'/>}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-3 left-6' >
          <div className='h-11 w-1 bg-black absolute top-[11vh] left-[3vh]'/>
          ...
          <div>
            ...
            <input type="text"
              ...
              className='p-2 bg-slate-100 rounded-lg w-4/5 pl-8'
            />
          </div>
          <div>
