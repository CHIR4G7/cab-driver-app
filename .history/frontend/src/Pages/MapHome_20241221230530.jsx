        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-1 left-6 ' >
          ...
          <div>
            ...
            <input type="text"
              ...
              className='p-2 bg-slate-100 rounded-lg w-7/8 pl-8 focus:outline-none'
              {...register('pickup',{
          ...
          {/* <div className='h-4 w-4 bg-black flex flex-col justify-center items-center absolute top-[18vh] left-[0.1vh]'>
            ...
            <input type="text"
              ...
              className='p-2 bg-slate-100 rounded-lg w-full pl-8 focus:outline-none'
              {...register('destination',{
                required:"Please Enter your Destination!"
              })}
            />
          </div>
          <button className='border-2 border-black text-white bg-black w-[78%] p-2 rounded-lg flex flex-row items-center justify-center mt-4'>Book a Ride</button>
        </form>
