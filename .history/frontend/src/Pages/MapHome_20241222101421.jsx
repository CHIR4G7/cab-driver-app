  ...
  return (
    <div>
      ...
      <div className={`fixed bottom-0 ${booking ? '' : 'hidden'} bg-white w-full rounded-lg`}>
        ...
        <div className='flex flex-row gap-2 rounded-xl focus:border-2 border-black '>
        ...
        <div className='border-2 border-black flex flex-row gap-2 rounded-xl m-2'>
          <img src={moto} alt="motorcycle" className='h-20 w-21 ' />
        ...
        <div className='border-2 border-black flex flex-row gap-2 rounded-xl m-2'>
          <img src={auto} alt="car" className='h-20 w-21 ' />
