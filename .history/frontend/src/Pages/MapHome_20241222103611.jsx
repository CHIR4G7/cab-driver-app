...
const MapHome = () => {
  ...
  return (
    <div>
      ...
      <div ref={panelRef} className={`absolute bg-white w-full flex flex-col gap-3 p-2  pl-6 pb-3 ${selecting ? 'top-0 mt-4 rounded-xl h-screen' : 'bottom-0 rounded-3xl'} ${booking ? 'hidden' : ''}`} onClick={() => setSelecting(true)}>
      ...
      <div className={`fixed bottom-0 ${booking ? '' : 'hidden'} bg-white w-full rounded-lg`}>
        <span className='font-medium text-2xl ml-2 pt-3'>Choose Your Ride</span>

        <div className='border-2 border-black flex flex-row gap-2 rounded-xl m-2'>
          ...
          <div className='flex flex-col'>
            ...
            <span className='text-gray-500'>Affordable,Compact Rides</span>
          </div>
          <span className='mt-3'>₹193.24</span>
        </div>

        

        <div className='border-2 border-black flex flex-row gap-2 rounded-xl m-2'>
          <img src={moto} alt="motorcycle" className='h-[11vh] w-[12.5vh]' />
          ...
          <div className='flex flex-col'>
            ...
            <span className='text-gray-500'>Affordable,MotoCycle Rides</span>
          </div>
          <span className='mt-3'>₹193.24</span>
        </div>
        ...
        <div className='border-2 border-black flex flex-row gap-2 rounded-xl m-2'>
          ...
          <div className='flex flex-col'>
            ...
            <span className='font-bold'>5 mins away</span>
            <span className='text-gray-500'>Affordable,Auto Rides</span>
          </div>
          <span className='mt-3'>₹193.24</span>
        </div>
