  ...
  return (
    <div>
      ...
      <div className={`fixed bottom-0 ${booking ? '' : 'hidden'} bg-white w-full rounded-2xl pt-4 pb-4`}>
        <span className='font-semibold text-2xl ml-2 pt-3'>Choose Your Ride</span>

        <div className=' active:border-black bg-gray-100 flex flex-row gap-2 rounded-xl m-2'>
        ...
        <div className='border-2 border-black bg-slate-100 flex flex-row gap-2 rounded-xl m-2'>
        ...
        <div className='border-2 border-black bg-gray-100 flex flex-row gap-2 rounded-xl m-2'>
