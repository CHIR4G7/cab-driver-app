...
const MapHome = () => {
  ...
  return (
    <div>
      ...
      <div ref={panelRef} className={`absolute bg-white w-full flex flex-col gap-3 p-2  pl-6 pb-3 ${selecting ? 'top-0 mt-4 rounded-xl h-screen pb-4' : 'bottom-0 rounded-3xl'} ${booking ? 'hidden' : ''}`} onClick={() => setSelecting(true)}>
