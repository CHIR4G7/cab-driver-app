...
const RideContext = ({children}) => {
  ...
  return (
    <RideDataContext.Provider value={{selecting,setSelecting,booking,setBooking,confirmRide,setConfirmRide,waitingForDriver,setWaitingForDriver,driverFound,setDriverFound,rideFound,setRideFound,rideStarted,setRideStarted}}>
      {children}
