...
const RideContext = ({children}) => {
  ...
  //users
   ...
   //for captains
   const [rideFound,setRideFound] = useState(true); // for pop ups whenever reides are avialbale
  ...
  return (
    <RideDataContext.Provider value={{selecting,setSelecting,booking,setBooking,confirmRide,setConfirmRide,waitingForDriver,setWaitingForDriver,driverFound,setDriverFound,rideFound,setRideFound,rideStarted,setRideStarted,confirmRideCaptain,setConfirmRideCaptain}}>
      {children}
